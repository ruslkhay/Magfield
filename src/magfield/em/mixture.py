class Mixture:
    ...
    def initialize_probs_mus_sigmas(self, random_seed: int, **kwargs) -> None:
        ...
        from magfield.em.algorithms import initialize_params
    ...
    def log_likelihood(self, data) -> float:
        ...
        """
        from magfield.em.algorithms import log_likelihood
    ...
    def EM_iterative(self, dataset, n_iterations: int) -> tuple:
        ...
        """
        from magfield.em.algorithms import EM_iter
    ...
    def EM_adaptive(self, dataset, accuracy: float):
        ...
        accuracy.
        """
        from magfield.em.algorithms import EM_adap
    ...
    def EM_sieving(
        ...
        **kwargs,
        ...
        from magfield.em.algorithms import EM_sieved
    ...
    def Kolmogorov_EM(self, dataset, train_perc=0.5, relprev_pos=1, random_seed=42):
        from magfield.em.algorithms import EM_KS
        from numpy import array
